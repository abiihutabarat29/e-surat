            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-info">
                        ...
                        <form action="<?= base_url('penandatangan/save') ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <img src="<?= base_url('media/ttd/blank.png') ?>" alt="image profile" width="80px" class="img-thumbnail rounded img-preview">
                                    </div>
