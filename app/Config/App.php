...
class App extends BaseConfig
{
	...
	|
	*/
	public $baseURL = 'https://e-arsippkk.batubarakab.go.id';
	// public $baseURL = 'http://localhost/dasawismaci/public/';
	// public $baseURL = 'http://localhost/esmaci/public/';

	//Api React Native
	// public $baseURL = 'http://192.168.83.15/dasawismaci/public/kecamatan/data';
